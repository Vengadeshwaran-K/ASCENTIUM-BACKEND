...
public class ComplianceController {
    ...
    public ResponseEntity<DashboardResponse> dashboard(@AuthenticationPrincipal AppUserPrincipal principal) {
        return ResponseEntity.ok(kycService.getComplianceDashboard(principal.getUser()));
    }

    @GetMapping("/pending")
    public ResponseEntity<List<KycResponse>> pending(@AuthenticationPrincipal AppUserPrincipal principal) {
        return ResponseEntity.ok(kycService.getPendingCompliance(principal.getUser()));
    }
    ...
    public ResponseEntity<List<AuditLogResponse>> auditTrail(@AuthenticationPrincipal AppUserPrincipal principal,
        ...
        return ResponseEntity.ok(kycService.getAuditTrailAsCompliance(principal.getUser(), id));
    }
    ...
    public ResponseEntity<KycResponse> accept(@AuthenticationPrincipal AppUserPrincipal principal,
        ...
        return ResponseEntity.ok(kycService.approveCompliance(principal.getUser(), id, comment));
    }
